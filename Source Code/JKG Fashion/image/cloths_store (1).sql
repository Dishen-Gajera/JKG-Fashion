...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 05, 2024 at 12:28 PM
...
(2, 'dishen', 8849792324, 'Bagarangpur');
...
CREATE TABLE `confirm_orders` (
  ...
  `conf_time` datetime NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `confirm_orders` (`conf_id`, `order_id`, `conf_name`, `conf_price`, `gender`, `size`, `qut`, `total`, `pay_mode`, `order_time`, `conf_time`) VALUES
(1, 1, 'Nike Tight t_shirt', 800, 'male', 'large', 6, 4800, 'cod', '2024-08-02 23:59:52', '2024-08-04 16:41:26'),
(2, 1, 'Tight Crop-Top', 700, 'female', 'medium', 6, 4200, 'cod', '2024-08-02 23:59:52', '2024-08-04 16:41:26');
...
(2, 'Nike Tight t_shirt', 800, 'male', 'large', 1, 800, 'Gpay', '2024-08-05 15:47:49'),
(2, 'Tight Crop-Top', 700, 'female', 'medium', 1, 700, 'Gpay', '2024-08-05 15:47:49');
