...
if(isset($_POST['undo'])){
    ...
    $result=mysqli_query($con,"SELECT * FROM cancel_orders WHERE order_id='$id'");


    while($data=mysqli_fetch_array($result)){
        $sql="INSERT INTO `orders`(`sr_number`, `prod_id`, `prod_name`, `prod_price`, `gender`, `size`, `prod_qut`, `total`, `pay_mode`, `date`) VALUES ('$data[sr_number]','$data[order_id]','$data[canc_name]','$data[canc_price]','$data[gender]','$data[size]','$data[qut]','$data[total]','$data[pay_mode]','$data[order_time]')";
    ...
    mysqli_query($con,"DELETE FROM `cancel_orders` WHERE order_id='$id'");
}
                                ...
                                <div class="card-body">
                                    <table id="example2" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <?php
                                            include("../config.php");
                                                $query="select * from buyers WHERE status=2";
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <?php
                                                    $query2 = " select * from cancel_orders WHERE order_id='$id'";
                                                    ...
                                                    <tr style="border: 2px dotted;">
                                                        ...
                                                        <td><?php echo $data2['canc_name']; ?></td>
                                                        <td><?php echo $data2['canc_price']; ?></td>
                                                        ...
                                                        <td><?php echo $data2['canc_time']; ?></td>
